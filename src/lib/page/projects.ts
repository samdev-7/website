let projects = [
    ...
    },
    {
        ...
        short: "Minecraft Mod",
        description: "My most popular creation with over 200K downloads. A <a rel='noopener' class='secondary-inline-url' href='https://minecraft.net/' target='_blank'>Minecraft</a> mod that adds Diamond Nuggets. Useful as currency on multiplayer communities.",
    },
    {
    ...
    },
    {
        ...
        description: "I am collaborating with <a rel='noopener' href='https://github.com/arexon/furnideco' class='secondary-inline-url'>@arexon</a> to bring Furnideco, his furniture addon for Minecraft Bedrock, to Minecraft Java. ",
    ...
    },
    {
        ...
        short: "Sprig Game",
        description: "Featured on the <a rel='noopener' class='secondary-inline-url' href='https://hackclub.com' target='_blank'>Hack Club</a><a rel='noopener' class='secondary-inline-url' href='https://hackclub.com/newsletter/' target='_blank'> newsletter</a>! This is a simple minesweeper game made using <a rel='noopener' class='secondary-inline-url' href='https://sprig.hackclub.com/' target='_blank'>Sprig</a>. 9 by 9 grid with 10 mines.",
    ...
    },
    {
        ...
        short: "Web App",
        description: "Built under 48 hours for the <a rel='noopener' href='https://ecohacks.devpost.com/' class='secondary-inline-url'>Eco Hacks 2022</a> hackathon. A quiz/game to test your knowledge in recycling.",
    ...
    },
    {
        ...
        short: "NEAT Project",
        description: "My experimentation with the <a rel='noopener' class='secondary-inline-url' href='https://en.wikipedia.org/wiki/Neuroevolution_of_augmenting_topologies' target='_blank'>NEAT</a> algorithm to create a neural network that can play a simple game. Drive the missile to the flag.",
    ...
    },
    {
        ...
        short: "Sprig Game",
        description: "My first game made with <a rel='noopener' class='secondary-inline-url' href='https://sprig.hackclub.com/' target='_blank'>Sprig</a>. A simple connect four game made using Sprig. Played with two players.",
        link: "https://editor.sprig.hackclub.com/?file=https://raw.githubusercontent.com/hackclub/sprig/main/games/connect_four.js",
        github_link: "https://github.com/hackclub/sprig/blob/main/games/connect_four.js"
    }
