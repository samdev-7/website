let langs = [
    {
        ...
        description: "Python is the first text-based programming language I learned. It is the language that I am most proficient in."
    },
    {
        name: "JavaScript",
    ...
    },
    {
        ...
        description: "I learned C++ in one of my extracurricular classes. I am not great at C++, but I am able to write basic algorithms."
    },
    {
        name: "HTML*",
        ...
        description: "This website was built with HTML. This is the technology that makes this website work. I am able to write HTML efficiently and quickly."
    },
    {
        name: "CSS*",
    ...
    },
    {
        ...
        description: "I was introduced to the possibilities programming through Scratch. It was easy to understand. I now focus more on text-based languages."
    },
    {
        name: "MongoDB",
        ...
        short: "Database",
        description: "I use MongoDB Atlas in my projects to store persistent data. It is an excellent database that integrates nicely with my projects."
    },
    {
        name: "Svelte",
        ...
        description: "Svelte powers this website. I just recently discovered it. It is amazing and easy to use. I am still learning more about it."
    },
    {
        name: "Flask",
    ...
    },
    {
        ...
        short: "CSS Framework",
        description: "Tailwind CSS is a utility-first CSS framework that is very easy to use. I use Tailwind CSS to style almost all my websites."
    },
    {
        name: "FastAPI",
        ...
        short: "Python Web Framework",
        description: "FastAPI is a Python web framework I recently started to use. I use it to create APIs for my web applications. It is powerful and fast."
    },
    {
        name: "Disnake",
